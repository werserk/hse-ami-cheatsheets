...
\begin{ProblemSteps}
\item \textbf{Однородная часть.} Найти $a_t^{(h)}$ методом характеристических корней (см. раздел~\secref{homogeneous}).
\item \textbf{Форма частного решения.} По таблице~\tabref{particular-form} выбрать форму $a_t^{(p)}$ с учётом правила резонанса.
