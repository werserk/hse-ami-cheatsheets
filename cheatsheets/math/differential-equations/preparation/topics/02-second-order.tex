\section{Минимальное ЛОУ: метод аннигиляторов}\label{sec:min-lre}
...
\subsection*{Шаг 2. Собрать общий аннигилятор}
