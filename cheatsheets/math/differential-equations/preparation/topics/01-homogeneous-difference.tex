\subsection{Однородные линейные разностные уравнения}\label{sec:homogeneous}

\HSEExample{\example Решите однородное линейное разностное уравнение:
\begin{align}
...
\HSEAlgorithm{\textbf{Алгоритм решения однородных разностных уравнений.}
\begin{ProblemSteps}
...
\item \textbf{Общий вид решения (см.~таблицу~\tabref{form-choices}).}
